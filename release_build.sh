...
if [ $? -eq 0 ]; then
    ...
    cd ./release
    zip -r TextToSpeechApp-v1.1.0-macOS.zip TextToSpeechApp.app
    cd ..
    
    echo "✅ Release package created: ./release/TextToSpeechApp-v1.1.0-macOS.zip"
    echo ""
    ...
    echo "2. Create a GitHub release with tag v1.1.0"
    echo "3. Upload the zip file as a release asset"
    echo "4. Use the content from RELEASE_NOTES_v1.1.0.md as release description"
...
echo "□ Create release with tag: v1.1.0"
echo "□ Upload: TextToSpeechApp-v1.1.0-macOS.zip"
