...
if [ $? -eq 0 ]; then
    ...
    cd ./release
    zip -r TextToSpeechApp-v2.1.1-macOS.zip TextToSpeechApp.app
    cd ..
    
    echo "✅ Release package created: ./release/TextToSpeechApp-v2.1.1-macOS.zip"
    echo ""
    ...
    echo "2. Create a GitHub release with tag v2.1.1"
    echo "3. Upload the zip file as a release asset"
    echo "4. Use the content from RELEASE_NOTES_v2.1.1.md as release description"
...
echo "□ Create release with tag: v2.1.1"
echo "□ Upload: TextToSpeechApp-v2.1.1-macOS.zip"
echo "□ Copy release notes from: RELEASE_NOTES_v2.1.1.md"
